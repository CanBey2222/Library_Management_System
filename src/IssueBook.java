...
public void clear(){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 0, 51, 40));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/2.jpg"))); // NOI18N
    ...
    private void btnissueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnissueActionPerformed
        if(txtid.getText().equals("")){
            ...
            try{
            pst=c.prepareStatement("UPDATE `library`.`book` SET `status` = 'Issued', issue_date = ?, due_date = ?,studentid =? WHERE (`id` = ?)");
